...
security_group_variables = {
  "security_group_1" = {
    security_group_tags = {
      "Name" = "sample-sg000001-prod"
    }
    security_group_name                   = "sample-sg000001-prod"
...
key_pair_variables = {
  "key_pair_1" = {
    key_pair_tags = {
      "Name" = "sample-kp000001-prod"
    }
    key_pair_key_name        = "sample-kp000001-prod"
...
instance_variables = {
  "instance_1" = {
    ...
    instance_key_name                             = "sample-kp000001-prod"
    ...
    instance_root_block_prodice = {
      root_block_prodice_delete_on_termination = true
      root_block_prodice_encrypted             = false
      root_block_prodice_iops                  = null
      root_block_prodice_kms_key_id            = null
      root_block_prodice_tags = {
        "Name" = "samplerv000001"
      }
      root_block_prodice_throughput  = null
      root_block_prodice_volume_size = 10
      root_block_prodice_volume_type = "gp2"
    }
    instance_ebs_block_prodice         = null
    instance_ephemeral_block_prodice   = null
