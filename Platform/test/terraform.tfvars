security_group_variables = {
  "security_group_0bc7-dop-aiops-splunk" = {
    security_group_tags = {
      "Name" = "0bc7-dop-aiops-splunk-SG"
    }
    security_group_name                   = "0bc7-dop-aiops-splunk-SG"
    security_group_description            = "0bc7-dop-aiops-splunk-SG-prod-non-prod"
    ...
    security_group_ingress = [
      {       #(Optional)
      ingress_from_port        = 3389   #(Required)
      ingress_to_port          = 3389   #(Required)
      ...
      ingress_security_groups  = ["sg-0b6ac8cec9d72c181"]
      ingress_self             = null
      },
      {       #(Optional)
      ingress_from_port        = 22   #(Required)
      ingress_to_port          = 22   #(Required)
      ingress_protocol         = "TCP" #(Required)
      ingress_cidr_blocks      = null
      ingress_description      = "airbus-lan-https"
      ingress_ipv6_cidr_blocks = ["::/0"]
      ingress_prefix_list_ids  = null
      ingress_security_groups  = ["sg-0c84ce84716eb7c43"]
      ingress_self             = null
      }
    ]
  /*
...
instance_variables = {
  "instance_sshd01" = {
    ...
    instance_availability_zone                    = "ca-central-1a" #"eu-west-1a"
    ...
    instance_private_ip                           = "172.31.16.4" #"10.102.170.50"
    ...
    instance_subnet_tags = {
      "Name" = "default1" #"subnet-ew1-0bc7-dop-nonprod-aiops-private-a"
    }
  },
